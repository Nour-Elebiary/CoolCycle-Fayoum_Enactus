# CoolCycle — Deliverable 1: ESP32-DevKit-V4 Pinout & Hardware Integration

> **Role**: Senior IoT & Systems Architect  
> **Target MCU**: ESP32-WROOM-32D (DevKit-V4, 30-pin variant)  
...
| **16** | RX2 | SIM800L/SIM7600 TX | UART2 | Cellular module RX |
| **17** | TX2 | SIM800L/SIM7600 RX | UART2 | Cellular module TX |
| **18** | GPIO18 | Neo-6M GPS TX | UART1 (SW) | Use SoftwareSerial or UART1 |
| **19** | GPIO19 | Neo-6M GPS RX | UART1 (SW) | GPS module |
...
| **4** | GPIO4 | DS18B20 (Internal Probe) | 1-Wire | 4.7kΩ pull-up to 3.3V; Waterproof variant mounted in geometric center |
| **5** | GPIO5 | DHT22 (Ambient Temp/Humidity) | Single-Wire | Strapping pin — safe after boot |
| **34** | GPIO34 | Reed Switch (Door Sensor) | Digital IN | Input-only. MUST add 10kΩ external pull-up and 10nF debounce cap |
| **35** | GPIO35 | LDR (Solar Intensity backup) | ADC1 CH7 | ADC1 safe with WiFi; use voltage divider |
| **25** | GPIO25 | Buzzer (Active, 3.3V) | Digital OUT | Drive via 2N2222/BC547 transistor |
| **26** | GPIO26 | LED (Red — Critical Alarm) | Digital OUT | 330Ω series resistor |
| **27** | GPIO27 | LED (Green — Status OK) | Digital OUT | 330Ω series resistor |
| **32** | GPIO32 | ADC1 CH4 (spare analog) | ADC1 | Reserved for LFP cell voltage tap |
| **33** | GPIO33 | ADC1 CH5 (spare analog) | ADC1 | Reserved for solar current raw |
| **23** | GPIO23 | SIM800L PWR_KEY / RESET | Digital OUT | Active LOW 1s pulse to power on |
...
| GPIO5 | DHT22 | HIGH=use default SPI clock | ✅ Safe — DHT22 idle=HIGH |
