...
| All clear | Green LED ON, Buzzer OFF |
...
```cpp
// SIM800L initialization sequence
void initCellular() {
...
|-------|-----------|-------|
| MCU | ESP32-DevKit-V4 (WROOM-32D) | Dual-core, 4MB flash |
...
| GPS | Neo-6M + TinyGPSPlus | UART1, NMEA sentences |
